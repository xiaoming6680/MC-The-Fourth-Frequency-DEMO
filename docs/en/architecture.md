...
The authoritative data flow, persistence, protocol and budgets of `1.0.0-rc.1`. Music has its own document ([Background music](audio.md)); trade-offs and rejected alternatives are in [Design notes](design-notes.md#architecture-and-lifecycle).
