...
| 4d | **First-boot graphics and ordinary direct entry** | First boot shows memory lamps, a scope and six states; ordinary opens show the page directly. Startup gently lights up on the audio page in about one second; pages fade in and out over about 0.6 seconds. After confirmation the MC menu appears inside the terminal glass, the camera approaches smoothly, the frame leaves view and filters clear. Menu controls then work normally |
